...
- If you want to browse all MIT classes follow [this link](http://student.mit.edu/catalog/index.cgi).

- If you want to browse course 6 (Comp. Sci. and Eng.) classes [go here](http://student.mit.edu/catalog/m6a.html).

- If you are an MIT student and you are thinking of taking some of the courses below but you aren't sure if you should, just [drop me an email](https://sanjass.github.io/contact/) or use the comment section below and I can share my thoughts with you.
...
<p>
 <ul style="font-size:16px">
  ...
  <li>6.819 - Advances in Computer Vision</li>
...
<ul style="font-size:16px">
  ...
  <li>6.036 - Intro to Machine Learning</li>
  <li>6.041A -  Intro to Probability I</li>
  <li>6.041B - Intro to Probability II</li>
  <li>21G.704 - Spanish IV</li>
  <li>IDS.UR  Undergraduate Research</li>
...
<ul style="font-size:16px">
  ...
  <li>6.URN - Undergraduate Research</li>
  <li>21G.703 - Spanish III</li>
  <li>21L.020 Globalization</li>
  <li>2.EPW UPOP Engineering Practice Workshop</li>
...
<details><summary><b>Spring 2017</b></summary>
<p>
<ul style="font-size:16px">
  <li>6.01 - Intro to EECS by Robot Sensing</li>
  <li>8.02 - Physics II</li>
  <li>14.01 -Principles of Microeconomics</li>
...
<details><summary><b>Fall 2016</b></summary>
<p>
<ul style="font-size:16px">
  <li>3.091 - Intro to Solid-State Chemistry</li>
  <li>8.01 - Physics I</li>
  <li>15.A03 - Operations Research & Math</li>
  <li>18.01A - Calculus</li>
  <li>18.02A - Calculus</li>
  <li>21G.222 - Expository Writing for Bilingual Students</li>
...
__________
#### ~Meta info~
1. To create collapsable markdown like above, you can use [this GitHub post](https://gist.github.com/joyrexus/16041f2426450e73f5df9391f7f7ae5f).
2. If you want to see your markdown change in real time as you type, use this [online editor](https://jbt.github.io/markdown-editor/).
