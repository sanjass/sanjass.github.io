...
<br>
<img src="/files/voe.gif" width="50%" height="auto" margin-left="25%" margin-right="25%"  display="block">
<br>
...
We want to develop models that can reason about the physical world from visual perspective, i.e. models that can simulate what our common sense tells us about the physical world based on what we have seen or are seeing. 
 ...
 - Based on the speed of the ball we know when we can expect to see the ball coming out of behind the occluder and we know the ball cannot teleport itself and arrive faster than expected (**Spatio-Temporal Continuity**). 
